    ...
    <div className="ios-card">
      <details className="group" open>
        <summary className="flex justify-between items-center p-4 bg-white cursor-pointer select-none active:bg-gray-50 transition">
          <div>
            <div className="text-[17px] font-bold text-gray-900">已导入图片</div>
            <div className="text-[11px] text-gray-500 mt-0.5 flex items-center gap-1.5">
              <span>共 <span className="font-bold text-[#007AFF]">{images.length}</span> 张</span>
              <span className="w-1 h-1 rounded-full bg-gray-300"></span>
              <span className="text-[#007AFF] bg-[#007AFF]/10 px-1.5 py-0.5 rounded font-medium">支持长按拖拽排序</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            {images.length > 0 && (
              <button
                ...
                className="text-[#FF3B30] text-[14px] font-medium bg-[#FF3B30]/10 px-3 py-1.5 rounded-full active:bg-[#FF3B30]/20 transition"
                id="clearBtn"
              >
                清空
              </button>
